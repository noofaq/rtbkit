        ...
        public BiddingAgent
{
    ...
    void setConfig()
    {
        ...
        config.creatives.push_back(Creative(0,0,"Joker",3));
        ...
        {
            RTBKIT::AugmentationConfig aug_conf;
            aug_conf.name = "redis-augmentor";
            ...
            config.addAugmentation(aug_conf);
...
int main(int argc, char** argv)
{
    ...
    RTBKIT::FixedPriceBiddingAgent agent(serviceProxies, "mopub-agent-ex");
